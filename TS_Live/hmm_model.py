        ...
        for i in range(len(df)):
          ...
          ## state 3 : etat normal --> hold
           ...
           # === Signaux et espaces min ===
            ...
            if new_state == 1 and self.prob_top > self.sensitivity and bars_since_top >= self.min_signal_gap  and bars_since_bottom >= self.min_signal_gap:
                    top_signal = True
                    bars_since_top = 0
                    bars_since_bottom += 1
            elif new_state == 2 and self.prob_bottom > self.sensitivity and bars_since_bottom >= self.min_signal_gap and bars_since_top >= self.min_signal_gap:
                    bottom_signal = True
                    bars_since_bottom = 0
                    bars_since_top += 1
            else:
