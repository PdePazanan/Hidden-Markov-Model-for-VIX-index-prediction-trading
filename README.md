...
The second model is obtained thanks to a LSTM with a MLP that had been trained with market features and the probability from the Hidden Markov Model, The folder LSTM contain the necessary to train the model.
